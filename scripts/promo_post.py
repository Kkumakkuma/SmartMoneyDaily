"""
SmartMoneyDaily - Gumroad Promotional Post Generator v2
...
PROMO_PRODUCTS = [
    {
        ...
        "price": "$7.99",
        "slug": "budget-planner",
        "desc": "Take control of your finances with our beautifully designed Notion budget planner.",
        "keywords": ["budgeting", "expense tracking", "money management", "financial planning"],
    },
    {
        "name": "Side Hustle Dashboard",
        "price": "$9.99",
        "slug": "side-hustle",
        "desc": "Launch and manage your side hustles from one powerful dashboard.",
        "keywords": ["side hustle", "extra income", "freelancing", "passive income"],
    },
]

PROMO_SYSTEM_PROMPT = """You are an expert personal finance writer.
