"""
SmartMoneyDaily - Gumroad Promotional Post Generator
...
PROMO_PRODUCTS = [
    {"name": "Monthly Budget Planner", "price": "$7.99", "slug": "budget-planner", "desc": "Take control of your finances with our beautifully designed Notion budget planner."},
    {"name": "Side Hustle Dashboard", "price": "$9.99", "slug": "side-hustle", "desc": "Launch and manage your side hustles from one powerful dashboard."},
]
